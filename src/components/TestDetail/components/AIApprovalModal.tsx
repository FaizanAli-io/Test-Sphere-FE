...
export default function AIApprovalModal({
  ...
  const handleApprove = async (aiQuestion: AIQuestionRaw, index: number) => {
    const questionData = {
      ...
      options:
        aiQuestion.type === "MULTIPLE_CHOICE" ? parseOptions(aiQuestion.options || "") : undefined,
      correctAnswer:
        aiQuestion.type === "MULTIPLE_CHOICE"
          ? findCorrectAnswer(aiQuestion.options || "", aiQuestion.correctAnswer || "")
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-3xl w-full max-w-4xl shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto">
        <div className="px-8 py-6 bg-gradient-to-r from-blue-500 to-indigo-600 sticky top-0 z-10">
          ...
          <p className="text-blue-100 mt-1">Review and approve questions generated by AI</p>
        </div>
          ...
          {pendingAIQuestions.map((aiQuestion, index) => (
            ...
            >
              <div className="mb-4">
                ...
                <h4 className="text-lg font-semibold text-gray-900 mb-3">{aiQuestion.question}</h4>
              </div>
              ...
              {aiQuestion.type === "MULTIPLE_CHOICE" && aiQuestion.options && (
                <div className="mb-4">
                  ...
                  <div className="space-y-2">
                    {parseOptions(aiQuestion.options).map((option, optIndex) => {
                      const isCorrect =
                        findCorrectAnswer(
                          aiQuestion.options || "",
              ...
              {aiQuestion.type === "TRUE_FALSE" && (
                <div className="mb-4">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div
                      className={`p-3 rounded-lg border ${
                        String(aiQuestion.correctAnswer || "").toLowerCase() === "false"
                          ? "bg-green-50 border-green-200 text-green-800"
                          : "bg-gray-50 border-gray-200"
                      }`}
                    >
              ...
              {(aiQuestion.type === "SHORT_ANSWER" || aiQuestion.type === "LONG_ANSWER") &&
                aiQuestion.correctAnswer && (
                  <div className="mb-4">
                    <h5 className="font-medium text-gray-700 mb-2">Sample Answer:</h5>
